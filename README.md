# Jogo Genius com Arduino Uno

Este repositório contém a implementação de um **jogo Genius** utilizando o **Arduino Uno**, desenvolvido como projeto final da disciplina **Introdução aos Sistemas Embarcados**.
...
## 🕹️ Descrição do Jogo Genius

O jogo Genius funciona da seguinte forma:
